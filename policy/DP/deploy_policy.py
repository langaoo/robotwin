...
def get_model(usr_args):
    ...
    ckpt_file = f"./policy/DP/checkpoints/data/{usr_args['task_name']}-{usr_args['ckpt_setting']}-{usr_args['expert_data_num']}_h-demo_randomized-{usr_args['seed']}/{usr_args['checkpoint_num']}.ckpt"
