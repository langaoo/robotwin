...
# conda activate depth3
# python /data/gl/RoboTwin/policy/DP2DP3/features_model/tools/depth_guided_film_drifting/train_film_drifting_v18_mtbcadapt.py --config /data/gl/RoboTwin/policy/DP2DP3/features_model/configs/depth_guided_film_drifting/train_film_drifting_v18_mtbcadapt_template.yaml
...
# bash eval.sh place_fan demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42-05 50 0 "0" 300 6 100
# bash eval.sh place_fan demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42-05 50 0 "0" 200 6 100
# bash eval.sh place_fan demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42-05 50 0 "0" 100 6 100

# bash eval.sh place_fan demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42-05 50 0 "0" 100 6 100
# bash eval.sh place_fan demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42-05 50 0 "0" 100 6 100
# bash eval.sh place_fan demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42-05 50 0 "0" 100 6 100

# bash /data/gl/RoboTwin/policy/DP2DP3/eval_film_drifting.sh dump_bin_bigbin demo_clean demo_clean-v18-mtbcadapt-raw-e600-seed42 50 0 "0" 200 6 100
# bash /data/gl/RoboTwin/policy/DP2DP3/eval_film_drifting.sh lift_pot demo_clean demo_clean-v18-mtbcadapt-raw-e600-seed42 50 0 "0" 300 6 100
# bash /data/gl/RoboTwin/policy/DP2DP3/eval_film_drifting.sh lift_pot demo_clean demo_clean-v18-mtbcadapt-raw-e600-seed42 50 0 "0" 400 6 100
# echo "[$(date +'%Y-%m-%d %H:%M:%S')] 恭喜，所有排队任务均已遍历执行完毕！(请检查上方输出确认各个任务的具体结果)"

# /data/gl/RoboTwin/policy/DP2DP3/checkpoints_film_drifting/lift_pot-demo_clean-v18-mtbcadapt-e600-seed42-50-0
# /data/gl/RoboTwin/policy/DP2DP3/checkpoints_film_drifting/lift_pot-demo_clean-v18-mtbcadapt-raw-e600-seed42-50-0
# /data/gl/RoboTwin/policy/DP2DP3/checkpoints_film_drifting/lift_pot-demo_clean-v18-mtbcadapt-raw-e600-seed42-50-0
...
# cd /data/gl/RoboTwin/policy/DP2DP3
# export DP2DP3_DEPLOY_CONFIG=/data/gl/RoboTwin/policy/DP2DP3/deploy_film_drifting_policy_v18_raw_arep.yml
# bash eval.sh open_laptop demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42 50 0 "0" 300 6 100
# bash eval.sh open_laptop demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42 50 0 "0" 200 6 100
# bash eval.sh open_laptop demo_clean demo_clean-v18-raw-arep-kgate-e300-seed42 50 0 "0" 100 6 100
