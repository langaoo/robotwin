...
# ✅ 导入单模型特征提取器 (只加载一个模型)
from features_common.single_model_extractor import SingleModelFeatureExtractor
...
class SingleModelInference:
    ...
    def _load_models(self):
        ...
        self.feature_extractor = SingleModelFeatureExtractor(
    ...
    def get_action(self, obs):
        ...
        if self.replan_every_call or len(self.action_queue) == 0:
            ...
            # 2. ✅ 提取单模型特征
            features_np = self.feature_extractor.extract_batch(images)  # [To, D]
